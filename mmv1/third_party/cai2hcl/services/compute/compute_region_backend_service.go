...
func (c *ComputeRegionBackendServiceConverter) convertResourceData(asset *caiasset.Asset, config *transport_tpg.Config) (*common.HCLResourceBlock, error) {
	...
	hcl, _ := flattenComputeRegionBackendService(assetResourceData, config)
...
func flattenComputeRegionBackendService(resource map[string]interface{}, config *transport_tpg.Config) (map[string]interface{}, error) {
